 ...
 */
//% weight=5 color=#FF00CC icon="\uf110" block="neopixel"
namespace neopixel_orange {
    /**
     * A NeoPixel strip
     */
    export class Strip {
        ...
        //% blockGap=8
        //% weight=80
        //% parts="neopixel_orange" advanced=true
    ...
    */
    ...
    //% advanced=true
    export function colors(color: ColorSensorPixelColors): number {
        return color;
    }
